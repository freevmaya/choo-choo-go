...
1. Используй уже реализованые методы конструирования примитивов: createBox, createSphere, createCylinder.
2. Переменные материалов создавай как свойство
3. см. пример конструирования паровозика
4. Каждый законченый элемент конструкции должен быть реализован в отдельном, приватном методе.
'''
